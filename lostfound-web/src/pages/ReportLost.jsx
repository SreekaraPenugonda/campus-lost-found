...
export default function ReportLost() {
  ...
  const [step, setStep] = useState(1); // 1: item details, 2: contact
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMsg('✅ Item reported! We\'ll notify you if we find a match.');
  ...
  return (
    <div className="report-page">
      <div className="report-header">
        ...
        <p>We'll help you find it. Takes 30 seconds.</p>
      </div>
        ...
        {step === 1 && (
          <>
            ...
            <div className="form-group">
              ...
              <textarea
                rows="3"
                placeholder="Any details that help identify your item..."
            ...
            {isGuest ? (
              <div className="guest-contact">
                <p className="guest-info">
                  📱 No account needed. We'll contact you when we find a match.
                </p>
                <div className="form-group">
