...
export default function ReportFound() {
  ...
  const handleSubmit = async (e) => {
    ...
    setMsg('');
    try {
      await api.post('/items/', { ...form, status: 'FOUND' });
    ...
    <div className="report-page">
      ...
      <form onSubmit={handleSubmit} className="report-form">
        <div className="form-group">
          ...
          <input placeholder="e.g., Black Wallet, Samsung Phone, Keys" value={form.title} onChange={e => setForm({...form, title: e.target.value})} required />
        </div>

        <div className="form-group">
          <label>Description *</label>
          <textarea rows="4" placeholder="Describe the item you found..." value={form.description} onChange={e => setForm({...form, description: e.target.value})} required />
        </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input placeholder="Where did you find it?" value={form.building} onChange={e => setForm({...form, building: e.target.value})} required />
          </div>
          <div className="form-group">
            <label>Room (Optional)</label>
            <input placeholder="Specific location" value={form.room} onChange={e => setForm({...form, room: e.target.value})} />
          </div>
        </div>
